...
public class mockupController {
        ...
        public ResponseEntity<String> initializeDB() throws Exception {
                ...
                productService.createProduct(new Product(null, "Guante cepillo",
								...
								authService.register(new RegisterRequest("Ivan", "Ivan", "Natucce", "anatucce@uade.edu.ar",
                    						LocalDate.of(2020, 1, 8), "1234", Role.ADMIN));
								authService.register(new RegisterRequest("Joanna", "Joanna", "Lazarte", "jlazartelagos@uade.edu.ar",
																LocalDate.of(2020, 1, 8), "1234", Role.ADMIN));
								authService.register(new RegisterRequest("Patricio", "Patricio", "Plem", "pplem@uade.edu.ar",
                                LocalDate.of(2020, 1, 8), "1234", Role.ADMIN));
								authService.register(new RegisterRequest("Santiago", "Santiago", "Lopez", "santiagonlopez@uade.edu.ar",
                                LocalDate.of(2020, 1, 8), "1234", Role.ADMIN));
								authService.register(new RegisterRequest("Tomas", "Tomas", "Diaz", "todiaz@uade.edu.ar",
                                LocalDate.of(2020, 1, 8), "1234", Role.ADMIN));
								//Test customer
								authService.register(new RegisterRequest("JuanPerez", "Juan", "Perez", "santiagonlopez@uade.edu.ar",
                                LocalDate.of(2020, 1, 8), "1234", Role.USER));
